...
2. Read relevant product feature specs.
3. Read relevant files in `rules/`.
4. Confirm data, child-data, consent, RLS, payment, and vendor impact.
5. Create a plan and get approval before implementation.
